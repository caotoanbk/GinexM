...
Route::get('/proponent/tong-ket-tam-ung-thang', 'ProponentController@tongketthang');
...
Route::get('/secrectary/tong-ket-tam-ung-thang', 'SecrectaryController@tongketthang');
...
Route::get('/curator/tong-ket-tam-ung-thang', 'CuratorController@tongketthang');
...
Route::get('/proponent/tong-ket/hang-muc/data/{year}/{month}', 'DatatablesController@tongkethangmuc_proponent');
Route::get('/proponent/tong-ket/booking/data/{year}/{month}', 'DatatablesController@tongketbooking_proponent');
