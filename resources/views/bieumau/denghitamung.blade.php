...
<head>
  ...
  <style type="text/css">
    ...
    .gwd-p-1s2v {
      ...
      text-align: center;
      font-weight: bold;
      transform-origin: 115.5px 27px 0px;
      font-size: 28px;
      transform-style: preserve-3d;
      left: 198px;
      top: 86px;
    ...
    .gwd-p-a9b6 {
      ...
      font-size: 14px;
      font-weight: normal;
      transform-origin: -433.5px 4.5px 0px;
      transform-style: preserve-3d;
      width: 203px;
      height: 64px;
      text-align: center;
    ...
    .gwd-p-1a6e {
      ...
      width: 383px;
      height: 69px;
      transform-origin: 115.5px -97px 0px;
      left: 198px;
      top: 249px;
    ...
    .gwd-p-12ww {
      ...
      font-family: 'Times New Roman';
      color: rgb(0, 0, 0);
      transform-origin: 128.5px -57px 0px;
      transform-style: preserve-3d;
      left: 28px;
      top: 478px;
      width: 442px;
  ...
  <table style="" class='dntu'>
    <tbody style="">
      <tr>
        ...
        <th rowspan="2">Hạ</th>
        <th rowspan="2">Kí HQ giám sát</th>
        <th rowspan="2">Phát sinh (nếu có)</th>
